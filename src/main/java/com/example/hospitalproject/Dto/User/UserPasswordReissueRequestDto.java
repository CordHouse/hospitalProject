...
public class UserPasswordReissueRequestDto {
    ...
    @ApiModelProperty(value = "사용자의 비밀번호를 재발급 받기 위한 사용자 아이디 입력", example = "test1234")
    ...
    @ApiModelProperty(value = "사용자의 비밀번호를 재발급 받기 위한 사용자 이메일 입력", example = "test123@test.com")
    ...
    @ApiModelProperty(value = "사용자의 비밀번호를 재발급 받기 위한 사용자 전화번호 입력", example = "010-1234-5678")
